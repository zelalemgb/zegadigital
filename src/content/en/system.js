...
module.exports = {
  strings: {
    ...
    ui: {
      ...
      optProgress: '2  Progress & certificate 🎓',
      ...
      progCertTitle: '🎓 *Your certificate*',
      progCertReady: "✅ You've completed everything — your official certificate is ready!\nReply *CERTIFICATE* to receive it now.",
      progCertQuiz: 'All lessons done ✅ — now pass your track quiz to unlock your certificate.',
      progCertProgress: '{{bar}}  {{pct}}%\n{{done}} of {{total}} lessons done — *{{remaining}} to go* to earn your certificate. Keep going! 💪',
