...
module.exports = {
  ...
  strings: {
    ...
    ui: {
      ...
      lessonLine: '{{title}} ({{module}}፣ ~{{mins}} ደቂቃ)',
      ...
      optProgress: '2  እድገት እና ምስክር ወረቀት 🎓',
      ...
      progCertTitle: '🎓 *የእርስዎ የምስክር ወረቀት*',
      progCertReady: '✅ ሁሉንም አጠናቀዋል — ኦፊሴላዊ የምስክር ወረቀትዎ ዝግጁ ነው!\nለመቀበል *CERTIFICATE* ይላኩ።',
      progCertQuiz: 'ሁሉም ትምህርቶች ተጠናቀዋል ✅ — የምስክር ወረቀትዎን ለመክፈት አሁን የትራክ ፈተናዎን ያልፉ።',
      progCertProgress: '{{bar}}  {{pct}}%\n{{done}} ከ {{total}} ትምህርቶች ተጠናቀዋል — የምስክር ወረቀት ለማግኘት *{{remaining}} ቀርተዋል*። ቀጥሉ! 💪',
      ...
      optInPrompt: '🔔 እድገትዎን እንዳያጡና ምስክር ወረቀትዎን በፍጥነት እንዲያገኙ ወዳጃዊ ማስታወሻ ይፈልጋሉ? ለማብራት *REMIND ON* ይላኩ (ወይም ለመዝለል *REMIND OFF*)። በማንኛውም ጊዜ ማቆም ይችላሉ።',
      liteOn: '📶 የመረጃ ቆጣቢ ሁነታ በርቷል። ትምህርቶች መረጃ ለመቆጠብ በጽሑፍ ብቻ ይመጣሉ። ወደ ስዕል ትምህርቶች ለመመለስ በማንኛውም ጊዜ CARDS ይላኩ።',
      liteOff: '🖼️ የስዕል ትምህርቶች በርተዋል። ወደ ጽሑፍ ብቻ ተቀይሮ መረጃ ለመቆጠብ በማንኛውም ጊዜ LITE ይላኩ።',
      ...
      certConfirmName: '📝 የምስክር ወረቀትዎ በዚህ ስም ይታተማል፦\n\n*{{name}}*\n\nትክክል ነው? ለማረጋገጥ *YES* ይላኩ፣ ወይም ለመቀየር ትክክለኛውን ስም ብቻ ይጻፉ።',
      ...
      certHookIntro: '🎓 *በ Meta የተመሰከረለት የዲጂታል ዜጋ ይሁኑ!*\nአንድ ትራክ — ሁሉንም ትምህርቶች እና ፈተናውን — ሲጨርሱ ከ OMNI Ethiopia እና Meta የቀረበ ኦፊሴላዊ የዜጋ ዲጂታል የምስክር ወረቀት ያገኛሉ።',
      certCountdown: '🎓 የምስክር ወረቀትዎን ለማግኘት {{n}} ተጨማሪ ትምህርት(ቶች) ይቀርዎታል።',
    },
  },
