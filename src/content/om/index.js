...
module.exports = {
  ...
  strings: {
    ...
    ui: {
      ...
      lessonLine: '{{title}} ({{module}}, ~daq. {{mins}})',
      ...
      optProgress: '2  Guddina & waraqaa ragaa 🎓',
      ...
      progCertTitle: '🎓 *Waraqaa ragaa keessan*',
      progCertReady: "✅ Hunda xumurtaniittu — waraqaan ragaa keessan qophaa'eera!\nFudhachuuf *CERTIFICATE* jedhaa ergaa.",
      progCertQuiz: 'Barnoonni hundi xumurameera ✅ — waraqaa ragaa banachuuf amma qormaata karaa keessanii darbaa.',
      progCertProgress: '{{bar}}  {{pct}}%\n{{done}} / {{total}} barnoota xumurtan — waraqaa ragaa argachuuf *{{remaining}} hafe*. Itti fufaa! 💪',
